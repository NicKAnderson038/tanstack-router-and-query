...
<br/>
<img src="https://miro.medium.com/v2/resize:fit:1400/1*TvS-_gheI34Q29y3BxyB6g.png" width="400" />
<br/>
<img src="https://miro.medium.com/v2/resize:fit:513/0*uDVm_lpP4hH14Uli.png" width="400" />
<br/>
<br/>
...
```bash
npx create-tsrouter-app@latest tanstack-router-and-query --list-add-ons
# ||
npx create-tsrouter-app@latest tanstack-router-and-query --tailwind --template file-router --add-ons tanstack-query #,start,store
```
